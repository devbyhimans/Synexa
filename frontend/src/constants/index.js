...
// it is used for the change Theme dropdown options to select the theme 
export const THEMES = [
  {
    name: "light",
    label: "Light",
...
// It is used in the onboarding page for selecting the native language and learning language
